...
public class CrossDomainServiceCaller {
	...
	public String retrieveContent(String formattedURL, int timeout,
	...
	private boolean isAcceptableHTTPResponse(HttpURLConnection conn) {
		...
		try {
			...
			exceptionPrinter
					.print(
							"Unable to determine whether or not a valid response was received due to exception. url = "
									+ conn.getURL().toString(), e);
		}
